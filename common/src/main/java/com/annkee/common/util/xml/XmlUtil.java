package com.annkee.common.util.xml;

import com.annkee.common.util.time.DateUtil;
...
public class XmlUtil {
    ...
    protected static void parseChildren(Field field, Element element, Object object) {
        ...
        if (isSimpleType(type)) {
            try {
                //  过时方法 element.setAttributeValue();
    ...
    protected static void setter(Object obj, String att, Object value, Class<?> type) {
        try {
            ...
            if (type == String.class) {
                ...
                method.invoke(obj, DateUtil.parseStr2Date((String.valueOf(value))));
            } else {
