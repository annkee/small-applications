package com.annkee.base.webservice;
 ...
 * @date 2018/11/28
 */
@WebService(serviceName = "UserService", targetNamespace = "http://service.demo.example.com", endpointInterface = "com.annkee.base.webservice.UserService")
@Component
@Slf4j
